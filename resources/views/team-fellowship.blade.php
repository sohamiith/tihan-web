    ...
    <div class="preloader d-flex align-items-center justify-content-center">
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="hero-cap pt-100">
                                <h2>TiHAN Faculty Fellowship</h2>
                                <nav aria-label="breadcrumb ">
                                    <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">Team</a></li>
                                    <li class="breadcrumb-item"><a href="#">Faculty Fellowship Details</a></li> 
                                    </ol>
                                </nav>
                            </div>
                        </div>
		...
		<div class="container box_1170">
			<div class="section-top-border">
				<h3 class="mb-30">TiHAN Faculty Fellowship</h3>
				<div class="progress-table-wrap">
					<div class="progress-table">
						...
						<!-- <div class="table-row">
							...
							<div class="country"> <img src="/img/elements/f7.jpg" style="width:20%;" alt="flag">Canada</div>
